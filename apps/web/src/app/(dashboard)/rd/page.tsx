...
export default function RdPage() {
  ...
  useEffect(() => {
    fetch('/api/proxy/v1/rd/summary').then(r => r.json()).then(d => setSummary(d.data ?? {}))
  }, [])
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold">R&D Management</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          { label: 'Publications', value: summary.publications ?? 0, color: 'bg-purple-50 border-purple-200' },
        ].map(c => (
