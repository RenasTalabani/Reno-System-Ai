...
import {
  ...
  Building, UsersRound, Boxes, Brain, BarChart3, Workflow, Package,
} from 'lucide-react'
...
const navigation = [
  ...
  },
  {
    group: 'Intelligence',
    items: [
      { label: 'Reno Brain', href: '/brain', icon: Brain, disabled: true, badge: 'Phase 10' },
      { label: 'Automation', href: '/automation', icon: Workflow, disabled: true, badge: 'Phase 10' },
    ],
  },
  {
    group: 'System',
    ...
    <aside className="flex flex-col w-60 bg-sidebar border-r border-sidebar-border min-h-screen shrink-0">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-sidebar-border">
        ...
        <div>
          ...
          <span className="block text-xs text-sidebar-foreground/50">v6.0.0</span>
        </div>
      </div>
