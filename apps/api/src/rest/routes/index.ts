...
import { webhooksModuleRoutes } from './webhooks/index.js'
import { eventBusModuleRoutes } from './event-bus/index.js'
...
import { fineTuningModuleRoutes } from './fine-tuning/index.js'
...
import { certificationModuleRoutes } from './certification/index.js'
...
export async function registerRoutes(app: FastifyInstance) {
  ...
  await app.register(
    async (v1) => {
      ...
      await v1.register(apiGatewayModuleRoutes, { prefix: '' })
      await v1.register(webhooksModuleRoutes, { prefix: '' })
      await v1.register(eventBusModuleRoutes, { prefix: '' })
      ...
      await v1.register(fineTuningModuleRoutes, { prefix: '' })
      ...
      await v1.register(certificationModuleRoutes, { prefix: '' })
